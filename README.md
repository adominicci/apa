...
Version 0.1.5 supports student papers on macOS 11 or newer. It is distributed
...
3. Open Tesina from Applications. macOS will block this first launch because
   version 0.1.5 is not signed or notarized with an Apple Developer certificate.
