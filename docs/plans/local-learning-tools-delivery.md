...
| --- | --- | --- | --- |
| P0 | None; canonical planning only | Merged | Plan approval |
| LT-01 | `add-bilingual-spelling-service` | Merged | Current-head diagnostics and private installers passed; physical Intel/Windows proof remains deferred to the final rollout gate |
| LT-02 | `add-bilingual-spelling-experience` | In review | Default production spelling remains absent; internal editor proof and final physical keyboard/accessibility evidence are separate gates |
