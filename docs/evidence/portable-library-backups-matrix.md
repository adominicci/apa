...
| Exact-candidate automated macOS package (11.8) | 📦 `MAC17-AUTOMATED-E0BBBB4-20260819`: source `e0bbbb48faddb403ff8470ed4a8502da7e27cf07`, app version 0.1.17, package SHA-256 `9ca56db58db0cc988039a1615fa79fda0a10808dba8c707e533176db7872cdb0`, executable SHA-256 `8f551c902a5027ec97f3e4c3a64c6ea7f25ac56ccecce300189734ec166f3e68`; four launches, restart scope, safe manual replacement, seven-version retention, and exact fixture restore passed. See `v0.1.17-automated-packaged-smoke.md`. |
| Automated packaged export/reopen harness (4.6) | 📦 `PKG-PORTABLE-E0BBBB4-20260819`: the exact `e0bbbb48faddb403ff8470ed4a8502da7e27cf07` candidate passed `deno task smoke:portable:packaged` under bundle identifier `app.tesina.desktop.portable-smoke.f46f4d4089404dc7abcef07c4d3f1ef9`; exact counts and relationships matched the full-library fixture, every figure byte matched after independent reopen, asset bytes totaled 95,818, and asset aggregate SHA-256 was `54e5c06f621dcce65778ca15595505259f09220a92a1a91e74b39f8e94583e71`. The compile-time smoke flavor is isolated from the shipping bundle, and success is emitted only after required task-owned cleanup. |
...
| Exact-feature-SHA Windows packaged acceptance (8.2, 11.5) | 📦 `WIN17-AUTOMATED-4A7C3E7-20260819`: CI run `32288245542`, job `96182798328`, installed and launched the generated NSIS smoke package on Microsoft Windows Server 2025 (`windows-2025-vs2026` image `20260810.198.2`) from exact source `4a7c3e75578ca39aa033508e91e7a19128784de4`. Four bounded packaged processes proved restart without reprompt, child create/reopen/list and wrong-hash refusal/hash-matched removal, real plugin-fs denial of parent/sibling/old/transient paths, safe replacement limited to the explicitly selected manual export, seven-version retention, and exact fixture restore. Package SHA-256 was `2e1c0c0360a4f11410f8013ff9ce311959ecd89a0847e0f76d48f8b93658fb8b`; installed executable SHA-256 was `5ae32d2ac96ee0cdfaaec952d03298821de6412e064b73db41a5c9bf3834ddcc`. The feature-only environment selectors exercise the shared post-selection native pipeline but do not prove literal shipping Windows folder/save dialogs or bit identity with the ordinary release flavor. Capability diff: `capabilities/default.json` adds deny-only renderer exclusions for `$APPDATA/.tesina-native`, `$APPDATA/.tesina-native/**`, `$APPCACHE/.tesina-native`, and `$APPCACHE/.tesina-native/**`; it adds no broad external grant, persisted scope, provider permission, or network permission. The smoke commands are compile-time-only. Signing/updater and provider-sync proof remain separate release evidence. See `v0.1.17-automated-packaged-smoke.md`. |
...
tasks 8.2, 11.5, and 11.8 are recorded in
`v0.1.17-automated-packaged-smoke.md`; the earlier
manual dialog and screenshot record remains in
`v0.1.17-macos-native-acceptance.md`. Task 12.8 remains pending PR review,
