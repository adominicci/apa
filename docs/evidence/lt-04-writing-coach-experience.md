...
| Focus and live region | Pass | Focus remained visible and predictable; the single polite status announced analysis, position changes, and stale navigation without duplicate live output or background focus movement. |
| Edit this passage | Pass | Current content returned to Write with the exact passage selected and focused, without automatic text changes. The stale path returned to Write without a guessed selection. |
